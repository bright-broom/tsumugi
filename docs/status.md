...
- 最終更新：2026-09-14（アイボリー・エスプレッソ・琥珀の3色リデザイン）
...
| ホーム本文 | アイボリー70%・エスプレッソ20%・琥珀10%をUI面積の目安として、広い図解・左右に分けた説明・料金比較・FAQを再構成。元の図解4点と全説明文を保持、本文のLucideアイコンは31→45。本文の構成はADR 0007、現行の配色はADR 0014 |
