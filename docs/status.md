...
- 最終更新：2026-09-17（6 種類の図解を Lucide で刷新）
...
| 検査 | 全項目 **PASS 572 / WARN 2 / FAIL 0**、静的 PASS 317 / WARN 2 / FAIL 0（対象なし 40 件）。WARN は未設定の本番公開条件と TOP の HTML 容量 109.9 KiB（目安 100 KiB）。容量基準は維持（ADR 0052） |
| 型・依存・文言 | `npm run check` が通る。ESLint エラー・警告 0、Vitest 482 件・料金モデル 12 件合格 |
