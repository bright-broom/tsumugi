...
| 上位商品の検討案           | [商品設計](business/premium-pricing-proposal.md)、`PROPOSED_PRICES`                                                                       | 検討価格と販売商品を分離。検討中のプランへ申込動作を追加しない                                                   |
...
- リポジトリの Public 維持と社内資料を含める承認は AGENTS.md にある。これを、認証情報・顧客実データの公開承認と解釈しない。
