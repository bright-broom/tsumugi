...
export const MIN_FONT_MB = 14;        // スマホでの本文・補助文字の下限。--text-fine（10.5pt）と同じ。旧 12px（ADR 0028）。ロゴの添え字などは SMALL_TEXT の除外に入れる
export const MIN_FIG_TEXT = 14;       // 図解の文字の画面上の実寸（SVG の値 × 表示倍率）の下限。390px と 1280px で測る（ADR 0028）
